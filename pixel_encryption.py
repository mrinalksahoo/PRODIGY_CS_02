...
def decrypt(image_path, output_path):
    ...
    for x in range(width):
        for y in range(height):
            r, g, b = img.getpixel((x, y))
            img.putpixel((x, y), (g, b, r))  # Swapping RGB values back to original
...
# Example usage
encrypt("example_image.png", "example_image.png")
decrypt("example_image.png", "example_image.png_image.png")
